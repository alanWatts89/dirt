...
import sty from "./PlasmicButton.module.css"; // plasmic-import: my69YTFDut9BnF/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: JsKouoon0CGOVx/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__xGxld)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___4XEjx)}
                role={"img"}
              />
            ),
