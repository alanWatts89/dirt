...
import sty from "./PlasmicIconLink.module.css"; // plasmic-import: cSCifWd1qCDiy6/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg__lef6A)}
              role={"img"}
            />
          ),
